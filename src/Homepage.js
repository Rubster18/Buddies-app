        ...
        <div className="homepage">
            <Header />
                <div className="jumbotron container">
                    <h1>Welkom op de beelbuddy</h1> 
                    <h2> Leuk dat je interesse hebt in het worden van een buddy!</h2>
                ...
                <div className="aboutus">
                    ...
                    <p> Deze site is ontstaan vanuit de gevolgen die het coronavirus heeft op studenten en mensen met een hulpvraag. 
                        Studenten Social work konden door het coronavirus niet meer op bezoek bij hun maatjes en de maatjes mochten geen studenten meer ontvangen en konden vaak ook niet naar hun werk en dagbesteding, een erg vervelende tijd. 

                        Dankzij beeldbellen konden beide groepen toch contact met elkaar houden!
                        En met succes. In april 2020 zijn er 15 studenten social work, vanuit de Hogeschool Utrecht,  gekoppeld aan mensen die behoefte hadden aan een praatje. Dit bleek een groot succes, zowel de studenten als hun maatjes ervaarde dit contact als erg prettig. Sommige hebben nog steeds contact en inmiddels ook in het echt afgesproken. 

                        Heb jij nou ook interesse om iemand zijn beeldbuddy te worden en 1-2 keer per week via een telefoon of tablet of computer contact met elkaar te hebben?
